    ...
    class Program
    {
        ...
        */
        ...
        public static int RemoveDuplicates(int[] nums)
        {
            ...
            int count = 1; // Count of unique elements, assuming the first element is unique
            ...
            for (int i = 1; i < nums.Length; i++)
            {
                ...
                if (curr != prev)
                {
                    nums[count] = curr; // Move unique element to its correct position
        ...
        */
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                ...
                List<int> resList = new List<int>(nums);
                return resList;
            }
            catch (Exception)
            {
        ...
        public static int LargestPerimeter(int[] nums)
        {
            try
            {
                ...
                for (int i = nums.Length - 1; i >= 2; i--)
                {
                    ...
                    if (a < b + c)
                    {
                        maxP = a + b + c; // Update maxP if a valid triangle is found
                        break;
                    }
                }

                return maxP; // Return the maximum perimeter found
            }
            catch (Exception)
            {
                throw;
        ...
        */
        ...
        public static string RemoveOccurrences(string s, string p)
        {
            try
            {
                while (s.Contains(p))
                {
                    int i = s.IndexOf(p); // Find the leftmost occurrence of p
                    s = s.Remove(i, p.Length); // Remove p from s
                }
                return s; // Return s after removing all occurrences of p
            }
            catch (Exception)
            {
                throw;
